...
import './assets/slitslider/js/modernizr.custom.79639.js';
import './assets/slitslider/js/jquery.ba-cond.min.js';
import './assets/slitslider/js/jquery.slitslider.js';
          ...
          <div class="sl-slider">
            ...
            >
              <div class="sl-slide-inner">
                ...
                <blockquote>
                  <p class="location">
                    <span class="glyphicon glyphicon-map-marker"></span> 1890
                    Syndey, Australia
                  </p>
                  <p>
