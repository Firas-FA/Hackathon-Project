    ...
    <><div className="container">
      <div className="card custom-card">
        ...
        <div className="card-body">
          <h5 className="card-title custom-card-title d-flex align-items-center"><img width="30" height="30" src="https://img.icons8.com/cotton/64/location--v1.png" alt="location--v1" /> :  {appartmentLocation}</h5>
          ...
          <p className="card-text custom-card-detail d-flex"><img width="30" height="30" src="https://img.icons8.com/fluency/48/000000/utah.png" alt="utah" />  :  {appartmentarea} m<sub>2</sub></p>
